    ...
    <div className="relative rounded-3xl overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="relative h-64 bg-gradient-to-br from-gray-800 to-gray-900 rounded-t-3xl overflow-hidden">
          ...
          <div className="absolute top-4 right-4 w-16 h-8 bg-gray-800/60 backdrop-blur-sm rounded-xl"></div>
        </div>

        {/* Content Skeleton */}
        <div className="p-6">
          <div className="h-5 w-24 bg-gray-800/60 rounded-md mb-3"></div>
          <div className="h-7 w-3/4 bg-gray-800/60 rounded mb-4"></div>
